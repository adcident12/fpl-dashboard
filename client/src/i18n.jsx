...
const STRINGS = {
  en: {
    ...
    'rivalry.tie': 'Dead even on {{points}} points — bragging rights are still up for grabs.',
    'rivalry.blowout': '{{winner}} is running away with it this week, {{margin}} pts clear. Brutal.',
  ...
  th: {
    ...
    'rivalry.tie': 'เสมอกันที่ {{points}} แต้ม — ยังไม่มีใครได้สิทธิ์คุยโว',
